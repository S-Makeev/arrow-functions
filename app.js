...
//'this' refers to the joe object upon which the method is being called
// 2. What is "this" when joe.scopeArrow() is invoked?
//'this' refers to a global object(window), that represents a browser window
// 3. Explain why "this" is different when an arrow function is used.
//'this' binds object to the scope of a function within which it's used, while an arrow function doesn't have binding functionality. It can only inherit 'this' value from the enclosing scope. 